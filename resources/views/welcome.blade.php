    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
                <div
                    class="text-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div
                        class="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                        <!-- Share Icon -->
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M8.59 13.51l6.83 3.98m0-11.01l-6.83 3.98" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Universal Saving</h3>
                    <p class="text-gray-600">Save from any website, Facebook, Instagram, TikTok, and more using sharing
                        URLs
                    </p>
                </div>
                <div
                    class="text-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div
                        class="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                        <!-- Tag Icon -->
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M7 7a2 2 0 1 1 4 0 2 2 0 0 1-4 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M5 7l7-7 7 7-7 7z" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Smart Tagging</h3>
                    <p class="text-gray-600">Organize your bookmarks with custom tags for quick filtering and discovery
                    </p>
                </div>
                <div
                    class="text-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div
                        class="w-16 h-16 bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                        <!-- Folder Icon -->
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M3 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2h7a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7z" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Custom Folders</h3>
                    <p class="text-gray-600">Create personalized folders to group related bookmarks and maintain perfect
                        organization</p>
                </div>
                <div
                    class="text-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div
                        ...
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
                            <polygon points="13 2 2 22 15 22 11 12 22 12 13 2" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Lightning Fast</h3>
                    <p class="text-gray-600">Find any bookmark instantly with powerful search and intelligent filtering
                    </p>
                </div>
            </div>
            ...
            <div class="text-center mb-20">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="relative">
                        <div
                            class="w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">
                            1</div>
                    ...
                    <div class="relative">
                        <div
                            class="w-12 h-12 bg-purple-600 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">
                            2</div>
                        <h3 class="text-xl font-semibold text-gray-800 mb-2">Organize Smart</h3>
                        <p class="text-gray-600">Add tags and place bookmarks in custom folders for easy organization
                        </p>
                    </div>
                    <div class="relative">
                        <div
                            class="w-12 h-12 bg-green-600 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">
                            3</div>
                ...
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="text-center">
                        <div class="relative inline-block">
                            <div
                                class="w-48 h-48 bg-gradient-to-r from-blue-100 to-purple-100 rounded-3xl flex items-center justify-center mx-auto">
            ...
            <div class="text-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 md:p-12 text-white">
                ...
                <p class="text-xl mb-8 opacity-90">Join thousands of users who have already transformed their digital
                    life
                </p>
